...
import ReactNative, {NativeModules, SectionList, StyleSheet, View} from 'react-native';
...
export default class AlphabetSectionList extends Component {
    ...
    renderSectionHeader({section: {title}}) {
        return (
            <View style={[styles.sectionHeader, this.props.sectionHeaderStyle]}>
                <BaseText style={this.props.sectionHeaderTextStyle}>{title}</BaseText>
            </View>
        )
    }
    ...
    render() {
        ...
        sectionList = this.props.hideRightSectionList
            ? null
            : <RightSectionList style={this.props.rightSectionStyle}
