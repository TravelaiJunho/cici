...
// API
import {declareItem, getCommentCount, like} from '../../data/http/TabToDaniel';
...
class TabToDanielItem extends BaseComponent {
    ...
    shouldComponentUpdate(nextProps, nextState, nextContext) {
        ...
        if (Common.shouldUpdate(this.state, nextState, ['item','isShowConfirm', 'confirmMessage', 'mediaIndex', 'mediaMeta', 'isLike', 'likeCount', 'commentCount', 'autoTrans', 'disableAutoTrans'])) return true;
        return false;
    }
    ...
    onPost = _ => {
        ...
        navRef.current.navigate(Screen.SCREEN_ACTIVITY.POST, {
            type: Screen.STACK_COMMUNITY.TAB_TO_DANIEL,
            item: item
        });
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(React.memo(TabToDanielItem));
