...
class TabFromDanielItem extends BaseComponent {
    ...
    onPost = _ => {
        ...
        navRef.current.navigate(Screen.SCREEN_ACTIVITY.POST, {
            type: Screen.STACK_COMMUNITY.TAB_FROM_DANIEL,
            item: item
        });
    }
    ...
    render() {
        ...
        return (
            <View style={s.container}>
                ...
                {/* Copy */}
                <PostCopy ref={ref => this.postCopy = ref}
                          name={nickname}
                          url={Common.isEmpty(image_url) ? '' : image_url}
                          grade={group_id}
                          onCopy={this.onCopy}/>
...
TabFromDanielItem.defaultProps = {
    item: null,
    isDetail: false,
    myItem: null,
    onRefresh: _ => {
...
export default connect(mapStateToProps, mapDispatchToProps)(React.memo(TabFromDanielItem));
