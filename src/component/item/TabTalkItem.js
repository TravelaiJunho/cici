...
// API
import {declareItem, getCommentCount, like} from '../../data/http/TabTalk';
...
class TabTalkItem extends BaseComponent {
    ...
    onPost = _ => {
        ...
        navRef.current.navigate(Screen.SCREEN_ACTIVITY.POST, {
            type: Screen.STACK_MEMBERSHIP.TAB_TALK,
            item: item
        });
    }
        ...
        return (
            <View style={s.layout_disable}>
                ...
                <View style={s.layout_disable_comment}>
                    <BaseTransText autoTranslate={disableAutoTrans}
                                   style={FontStyle.Cnt13WhiteLN}>{myItem.disable_comment}</BaseTransText>
                </View>
            </View>
        )
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(React.memo(TabTalkItem));
