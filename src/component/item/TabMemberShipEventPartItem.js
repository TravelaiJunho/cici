...
// API
import {declareItem, getCommentCount} from '../../data/http/TabEventForMemberShip';
...
class TabMemberShipEventPartItem extends BaseComponent {
...
TabMemberShipEventPartItem.defaultProps = {
    item: null,
    isDetail: false,
    onRefresh: _ => {
    }
...
TabMemberShipEventPartItem.propTypes = {
    item: PropTypes.any,
...
export default connect(mapStateToProps, mapDispatchToProps)(React.memo(TabMemberShipEventPartItem));
