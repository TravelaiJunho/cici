...
import {getCategoryList} from "../../data/http/TabNoticeForNotice";
import {getList} from "../../data/redux/action/TabNoticeForNotice";
...
class TabNotice extends BaseScreen {
    ...
    onFocus = _ => {
        ...
        onTabFocus && onTabFocus(Screen.STACK_NOTICE.TAB_NOTICE);
    }
    ...
    onDetail = item => {
        this.props.navigation.navigate(Screen.SCREEN_ACTIVITY.NOTICE_DETAIL, {
            type: Screen.STACK_NOTICE.TAB_NOTICE,
            item: item
        });
    }
...
const mapStateToProps = (state) => {
    return {
        ...
        // Tab Notice
        status: state.tab_notice_for_notice.get('status'),
        list: state.tab_notice_for_notice.get('list'),
        page: state.tab_notice_for_notice.get('page'),
        isRefresh: state.tab_notice_for_notice.get('isRefresh'),
    };
};
